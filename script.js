...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const lngInput = document.getElementById("startlong");
    const lat2Input = document.getElementById("stoplat");
    const lng2Input = document.getElementById("stoplong");
    ...
    lat2Input.addEventListener('input', function() {
        lat2 = parseFloat(this.value);
    });

    lng2Input.addEventListener('input', function() {
        lng2 = parseFloat(this.value);
    });
});
